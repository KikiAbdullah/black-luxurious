                    ...
                    <div class="page-content">
                        ...
                        <div class="swiper-container introslider">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide" style="background-image: url(images/cover/bg_mandala.png)">
                                    <div class="slider-caption">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <img src="images/cover/top.png" class="wedding-img" alt="" />
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="text-cover">
                                                        <h5>Kepada Bapak/Ibu Saudara/i</h5>
                                                        <h3>Kiki Rizka Abdullah</h3>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <a href="home.html">
                                                        <img src="images/ornament/btn_buka.png" style="width: 50%" alt="" />
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
